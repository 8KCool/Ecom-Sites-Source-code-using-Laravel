...
{
	// Image Quality
	$imageQuality = config('settings.upload.image_quality', 10);
...
function genPhoneNumberBtn($post, $btnBlock = false)
{
	...
	// Generate the Phone Number button
	$out .= '<a href="' . $btnLink . '" ' . $btnAttr . ' class="btn btn-default' . $btnClass . '">';
	$out .= '';
	$out .= $phone;
	$out .= '</a>';
	...
	if ($enableWhatsAppBtn) {
		...
		$out .= '<a href="' . $whatsAppLink . '" ' . $waBtnAttr . ' target="_blank" class="btn btn-default' . $waBtnClass . '">';
		$out .= '';
		$out .= 'WhatsApp';
		$out .= '</a>';
	}
