...
@section('content')
	...
	<div class="main-container">
		<div class="container">
						...
						<div style="background: #f2f4f5!important;" class="inner-box ">
							<div class="row">
								<div class="col-xl-12">
								    ...
								    <h2 style="margin-top:30px;" class="title-2 text-center">
						<strong>Parabéns! A sua conta foi criada.</strong>
						</h2>
								    
									<div style="padding-left: 0px;margin-bottom: 31px!important;" class="alert alert-success pgray alert-lg mb-0" role="alert">
										<p class="mb-0">
										Contudo, é necessário verificar o seu email para validar a sua conta. Etapa muito simples e importante para proteger a nossa comunidade contra perfis falsos.</a>
										</p>
									</div>
								</div>
			...
			<center><div style="margin-top:20px; margin-bottom:60px;" class="mb20 text-center">
							<a href="https://paiaki.com/" class="promover">
							 Ir à página inicial
								...
								<div style="margin-top:30px;" class="col-md-12 page-content">
