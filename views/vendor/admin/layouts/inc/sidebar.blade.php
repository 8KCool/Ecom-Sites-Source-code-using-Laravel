		...
		<div class="scroll-sidebar">
			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					@endif
					@if (auth()->user()->can('wallet-list') || userHasSuperAdminPermissions())
						<li class="sidebar-item">
							<a href="{{ admin_url('wallets') }}" class="sidebar-link">
								<i data-feather="dollar-sign" class="feather-icon"></i> <span class="hide-menu">{{ trans('admin.wallet') }}</span>
							</a>
						</li>
					@endif
					{!! $pluginsMenu !!}
					...
					@if (
						...
						|| auth()->user()->can('meta-tag-list-url')
