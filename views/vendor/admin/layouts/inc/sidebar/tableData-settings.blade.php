...
@endif
@if (auth()->user()->can('meta-tag-list-url') || userHasSuperAdminPermissions())
	<li class="sidebar-item">
		<a href="{{ admin_url('meta_tag_url') }}" class="sidebar-link">
			<i class="mdi mdi-adjust"></i>
			<span class="hide-menu">{{ trans('admin.meta tags url') }}</span>
		</a>
	</li>
@endif
